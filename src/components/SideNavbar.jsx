...
function SideNavbar() {
  ...
  return (
    <div className="min-h-screen z-50 fixed bg-black md:flex md:flex-col hidden border-r border-white border-opacity-20 w-[250px]">
      ...
      <div className="flex justify-center py-10 items-center text-white">
        <ul className="flex items-start flex-col px-2 gap-3">
          ...
          {/* Search item */}
          <Link to="/search" className={`font-semibold text-sm ${isActive("/search") ? "bg-[#27272A]" : ""
            } hover:bg-[#27272A] py-2 w-40 rounded-lg p-2`}>
            <li className="flex gap-1 items-center">
          ...
          <li className="flex gap-3 ml-1 items-center">
            {isLoggedIn ? (
              ...
              <Link to="/signin" className={`font-semibold text-sm ${isActive("/signin") ? "bg-[#27272A]" : ""
                } hover:bg-[#27272A] py-2 w-40 rounded-lg p-2`}>
