      ...
      <div>
        {isLoggedIn ? (
          <button
            ...
            className="flex items-center text-base bg-white rounded-full py-1.5 px-3 shadow-lg text-black gap-1"
          >
          ...
          <Link to="/signin">
            <button className="flex items-center text-base bg-white rounded-full py-1.5 px-3 shadow-lg text-black gap-1">
